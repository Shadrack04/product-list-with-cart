...
export function renderOrders(cartItem, matchingItem) {
  return `
    <div class="cart-items">
      <div class="cart-item-details">
        ...
        <p>
          ...
          <span class="amount">$${matchingItem.price * cartItem.quantity}</span>
        </p>
      </div>
      <button class="remove-cart-item-btn" data-matching-item-name='${
        matchingItem.name
      }'>
        <svg
          xmlns="http://www.w3.org/2000/svg"
